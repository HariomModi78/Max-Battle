...
for(let i=0;i<myOption.length;i++){
    myOption[i].addEventListener("click",function(e){
        ...
        }else if(myOption[i].classList[1] == "upcomming"){
            p.innerText = "My Upcomming";
        }else{
...
tournament[i].addEventListener("click",function(){
    ...
    footer.style.display = "none";
        ...
        if(tournament[i].classList[1] == "fullmap"){
        ...
        console.log(tournament[i].classList[1])
    window.location.href = `/tournament/upcomming/${tournament[i].classList[1]}/${tournament[i].id}`
})
