...
app.get("/myUpcomming",function(req,res){
    res.render("myUpcomming");
})
app.get("/myOngoing",function(req,res){
    res.render("myOngoing");
})
app.get("/myStatistics",function(req,res){
    res.render("myStatistics");
})
app.get("/myCompleted",function(req,res){
    res.render("myCompleted");
})
